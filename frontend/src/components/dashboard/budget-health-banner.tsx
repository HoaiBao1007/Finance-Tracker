...
export function BudgetHealthBanner({ budgets, periodLabel }: BudgetHealthBannerProps) {
  ...
  if (overview.exceededCount > 0) {
    return (
      <section className="rounded-[30px] border border-rose-200 bg-gradient-to-r from-rose-50 to-white p-5 text-rose-950 shadow-[0_18px_50px_rgba(244,63,94,0.08)]">
  ...
  if (overview.warningCount > 0) {
    return (
      <section className="rounded-[30px] border border-amber-200 bg-gradient-to-r from-amber-50 to-white p-5 text-amber-950 shadow-[0_18px_50px_rgba(245,158,11,0.08)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
  ...
  return (
    <section className="rounded-[30px] border border-emerald-200 bg-gradient-to-r from-emerald-50 to-white p-5 text-emerald-950 shadow-[0_18px_50px_rgba(16,185,129,0.08)]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
